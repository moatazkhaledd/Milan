...
if MsgText[1] == "رفع نائب مدير" or MsgText[1] == "رفع نائب المدير" ) then
if not msg.Director then return "⋆**هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
if not MsgText[2] and msg.reply_id then
if redis:get(dany..'lock:kara:'..msg.chat_id_) == 'off' then
...
local inline = {{{text="-قنآهہ‏‏ آلسـورس اضـغـط هـنـآ ",url="t.me/SourceMilan"}}}
send_key(msg.sender_user_id_,'   [قناة السورس : ميلان ](https://t.me/SourceMilan)' ,nil,inline,msg.id_)
return false
end

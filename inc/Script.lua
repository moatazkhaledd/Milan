...
local inline = {{{text="-قناة‏‏آلسـورس اضـغـط هـنـآ ",url="http://t.me/SORPET"}}}
send_key(msg.sender_user_id_,'   [قناة السورس : بيتر ](http://t.me/SORPET)' ,nil,inline,msg.id_)
return false
end
